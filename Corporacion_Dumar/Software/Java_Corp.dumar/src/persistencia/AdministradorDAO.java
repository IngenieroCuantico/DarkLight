...
public class AdministradorDAO {
	...
	public AdministradorDAO (int identificacionConstructor) {
	...
	public AdministradorDAO(String nombre) {
		
		this.nombre = nombre;
	}
	
	public AdministradorDAO(int identificacion, String nombre, int cantidad, int precio) {
